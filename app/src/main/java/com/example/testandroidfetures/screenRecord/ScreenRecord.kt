package com.example.testandroidfetures.screenRecord
...
class ScreenRecord : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recordToggleButton.setOnClickListener {
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                toggleScreenShare(recordToggleButton)
            }
        }
    }
    ...
    private fun initRecorder() {
        try {
            ...
            videoUri = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES).toString() +
            ...
            mediaRecorder.setVideoEncodingBitRate(1000 * 750)
